...
document.getElementById('p_button').onclick = function() {
    ...
    let message =  "p," + document.getElementById('color_text').value + "," + text_content;
    console.log(message)
...
document.getElementById('h1_button').onclick = function() {
    ...
    let message =  "h1," + document.getElementById('color_text').value + "," + text_content;
...
document.getElementById('h2_button').onclick = function() {
    ...
    let message =  "h2," + document.getElementById('color_text').value + "," + text_content;
...
document.getElementById('h3_button').onclick = function() {
    ...
    let message =  "h3," + document.getElementById('color_text').value + "," + text_content;
...
document.getElementById('h4_button').onclick = function() {
    ...
    let message =  "h4," + document.getElementById('color_text').value + "," + text_content;
...
document.getElementById('h5_button').onclick = function() {
    ...
    let message =  "h5," + document.getElementById('color_text').value + "," + text_content;
...
document.getElementById('h6_button').onclick = function() {
    ...
    let message =  "h6," + document.getElementById('color_text').value + "," + text_content;
